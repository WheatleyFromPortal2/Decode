...
public abstract class RedAuto extends BozoAuto { // these positions override the base auto class
    ...
    protected AutoConfig buildConfig() {
        ...
        return new AutoConfig(
                ...
                new Pose(86, 90, Math.toRadians(0)), // pickup1StartPose; hopefully this should also hit ball release (previously y=94)
                new Pose(118, 90, Math.toRadians(0)), // pickup1EndPose; hopefully this should also hit ball release (previously y=94)
