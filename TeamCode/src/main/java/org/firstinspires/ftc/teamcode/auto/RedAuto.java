...
public abstract class RedAuto extends BozoAuto { // these positions override the base auto class
    ...
    public static Pose scorePose = new Pose(93.39685635303888, 103.4801573265256,  -0.8);
    public static Pose scoreIntermediatePose = new Pose(99, 80, Math.toRadians(90));
    public static Pose pickup1StartPose = new Pose(102, 82, Math.toRadians(0));
    public static Pose pickup1EndPose = new Pose(126, 82, Math.toRadians(0));
    public static Pose pickup2StartPose = new Pose(102, 60, Math.toRadians(0));
    public static Pose pickup2EndPose = new Pose(138, 60, Math.toRadians(0));
    public static Pose pickup3StartPose = new Pose(102, 36, Math.toRadians(0));
    public static Pose pickup3EndPose = new Pose(138, 36, Math.toRadians(0));
    ...
    public static double scoreTurretPos = 1.4;
