...
public abstract class RedAuto extends BozoAuto { // these positions override the base auto class
    ...
    public static Pose scorePose = new Pose(93.39685635303888, 103.4801573265256,  -0.5);
    ...
    public static Pose pickup3StartPose = new Pose(100, 36, Math.toRadians(0));
    ...
    public static double scoreTurretPos = 1.2;
