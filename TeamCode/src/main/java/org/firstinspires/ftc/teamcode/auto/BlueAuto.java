...
public abstract class BlueAuto extends BozoAuto { // these positions override the base auto class
    ...
    public static Pose scorePose = new Pose(50.60314364696112, 103.4801573265256, Math.toRadians(180) + 0.5);
    ...
    public static Pose pickup3StartPose = new Pose(42, 35, Math.toRadians(180));
