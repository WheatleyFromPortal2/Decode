...
public abstract class BlueAuto extends BozoAuto { // these positions override the base auto class
    ...
    public static Pose pickup1StartPose = new Pose(39, 81, Math.toRadians(180));
    public static Pose pickup1EndPose = new Pose(18, 81, Math.toRadians(180));
    public static Pose pickup2StartPose = new Pose(42, 55, Math.toRadians(180));
    public static Pose pickup2EndPose = new Pose(6, 55, Math.toRadians(180));
    public static Pose pickup3StartPose = new Pose(42, 32, Math.toRadians(180));
    public static Pose pickup3EndPose = new Pose(6, 32, Math.toRadians(180));
