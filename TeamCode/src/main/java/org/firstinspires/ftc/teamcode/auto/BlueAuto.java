...
public abstract class BlueAuto extends BozoAuto { // these positions override the base auto class
    ...
    protected AutoConfig buildConfig() {
        return new AutoConfig(
                ...
                new Pose(58, 90, Math.toRadians(180)), // pickup1StartPose; hopefully this should also hit ball release (previously y=94)
                new Pose(26, 90, Math.toRadians(180)), // pickup1EndPose; hopefully this should also hit ball release (previously y=94)
                ...
                new Pose(8.5, 30, Math.toRadians(270)), // pickup4StartPose
                new Pose(8.5, 9, Math.toRadians(270)), // pickup4EndPose
                new Pose(26, 80, Math.toRadians(90)), // releasePose
