...
public class Constants {
    public static PIDFCoefficients translationalPIDF = new PIDFCoefficients(0.1, 0, 0.004, 0.11);
    public static FilteredPIDFCoefficients drivePIDF = new FilteredPIDFCoefficients(0.025, 0, 0.00001, 0.6, 0.06);
