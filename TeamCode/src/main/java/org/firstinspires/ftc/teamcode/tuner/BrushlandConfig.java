...
@TeleOp(name="BrushlandConfig", group="Tuner")
public class BrushlandConfig extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        /* Using this example configuration, you can detect both artifact colors based on which pin is reading true:
            pin0 --> purple
            pin1 --> green */
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 83 / 360.0 * 255, 90 / 360.0 * 255); // purple
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 100);
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 100 / 360.0 * 255, 110 / 360.0 * 255); // green
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 100);
    }
}
